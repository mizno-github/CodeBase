  ...
  <li class="mt-3 list-unstyled">
    <div class="bg-white rounded p-4">
      <div class="d-flex">
        ...
        <div>
          <p class="deleteId btn" data-toggle="modal" data-target="#modal1" data-delete="{{ route('errorCode.destroy', $errors->id) }}" data-title="{{ $errors->title }}"><i class="fas fa-trash fa-2x"></i></p>
        </div>
        <div>
          <p class="btn"><a href="{{ route('errorCode.edit', $errors->id) }}"><i class="fas fa-edit fa-2x"></i></a></p>
        </div>
      </div>
      <div>
        <div>
  ...
  <li class="mt-3 list-unstyled">
    <div class="bg-white rounded p-4">
      <div class="d-flex">
        ...
        <div>
          <p class="btn"><a href="{{ route('article.edit', $article->id) }}"><i class="fas fa-edit fa-2x"></i></a></p>
        </div>
        <div>
          <p class="deleteId btn" data-toggle="modal" data-target="#modal1" data-delete="{{ route('article.destroy', $article->id) }}" data-title="{{ $article->title }}"><i class="fas fa-trash fa-2x"></i></p>
        </div>
      </div>
      <div>
        <div>
